...
sources = (glob('3rdparty/spead2/src/common_*.cpp') +
           ...
           glob('src/*.cpp'))
# Generated file: might be missing from sources
gen_sources = ['3rdparty/spead2/src/common_ibv_loader.cpp']
for source in gen_sources:
    if source not in sources:
        sources.append(source)
headers = (glob('3rdparty/spead2/include/spead2/*.h') +
           glob('3rdparty/spead2/3rdparty/pybind11/include/pybind11/include/*.h'))
...
extensions = [
    Extension(
        ...
        extra_compile_args=['-std=c++17', '-g0', '-O3', '-fvisibility=hidden'],
