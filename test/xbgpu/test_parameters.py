...
# This is always set to 256 for the MeerKAT case and leads to packet sizes equal to 256 * 4 = 1 KiB. There is a chance
# that for the MeerKAT extension this could be configured to allow for packet sizes equal to 2 or 4 KiB. All these
# cases need to be tested.
num_samples_per_channel = [256, 512, 1024]

# Number of FFT channels out of the X-Engine
