...
def postproc_host(in0, in1, channels, acc_len, spectra, fine_delay, quant_scale):
    out0 = postproc_host_pol(in0, channels, acc_len, spectra, fine_delay, quant_scale)
    out1 = postproc_host_pol(in1, channels, acc_len, spectra, fine_delay, quant_scale)
