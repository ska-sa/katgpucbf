...
function. Some components of the xbgpu SPEAD interface require a monitor to be passed - this is why the NullMonitor is
needed.
...
TODO: Look at moving this class to a different repo to avoid repetition between here and fgpu.
"""
