...
class py_stream : public stream
{
  ...
  public:
    ...
    py_stream(int n_ants, int n_channels, int n_spectra_per_heap, int n_pols, int sample_bits, int timestamp_step,
              ...
              pybind11::object monitor)
        : stream(n_ants, n_channels, n_spectra_per_heap, n_pols, sample_bits, timestamp_step,
...
pybind11::module register_module(pybind11::module &parent)
{
    ...
    pybind11::class_<py_stream>(m, "Stream", "SPEAD stream receiver")
        .def(pybind11::init<int, int, int, int, int, int, std::size_t, std::size_t, stream::ringbuffer_t &, int, bool,
                            pybind11::object>(),
             "n_ants"_a, "n_channels"_a, "n_spectra_per_heap"_a, "n_pols"_a, "sample_bits"_a, "timestamp_step"_a,
        ...
        .def(
            ...
            "Add the buffer transport to the receiver. The receiver will read packet data python ByteArray generated by "
