...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--src-affinity", type=int, required=True, help="Core to which the receiver thread must be bound."
    )
    parser.add_argument(
        "--src-comp-vector",
        type=int,
    ...
    parser.add_argument(
        "--dst-affinity", type=int, required=True, help="Core to which the sender thread must be bound."
    )
    parser.add_argument(
        "--dst-interface",
        type=get_interface_address,
