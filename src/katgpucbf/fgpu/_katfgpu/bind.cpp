...
PYBIND11_MODULE(_katfgpu, m)
{
    ...
    receiver_class
        .def(py::init<int, std::size_t, std::size_t, receiver::ringbuffer_t &, int>(),
             "pol"_a, "packet_samples"_a, "chunk_samples"_a, "ringbuffer"_a,
             "thread_affinity"_a = -1, py::keep_alive<1, 5>())
